...
const RowContainer = ({ flag, data, scrollValue }) => {
    ...
    return (
        ...
        >
            {data && data.map((item)=>(
                <div key={item.id} className={"w-275 h-[200px] min-w-[275px] md:min-w-[340px] md:w-300  bg-cardOverlay rounded-lg py-2 px-4 my-12 backdrop-blur-lg hover:drop-shadow-lg flex flex-col items-center justify-evenly relative"}>
