...
import {storage} from "../firsebase.config";
        ...
        <div className={"w-full min-h-screen  flex items-center justify-center"}>
            <div className={"w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col " +
                ...
                <div className={"w-full flex flex-col md:flex-row items-center gap-3"}>
                    <div className={"w-full py-2 border-b border-gray-300 flex items-center gap-2"}>
                        ...
                        <input
                            ...
                            className={"w-full h-full text-lg text-textColor bg-transparent outline-none border-none " +
                ...
                <div className={"flex items-center w-full"}>
                    <button
                        type={"button"}
                        className={"ml-0 md:ml-auto w-full md:w-auto border-none outline-none bg-emerald-500 px-12 " +
